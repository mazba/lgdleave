                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <table class="table table-bordered table-responsive">
                            <tbody>
                                ...
                                <tr><th><?= __('Location Type') ?></th><td><?php echo $applications['location_type']['title_bn']; ?></td></tr>
                                <tr><th><?= __('Applicant Type') ?></th><td><?php echo $applications['applicant_type']['title_bn']; ?></td></tr>
                                <tr><th><?= __('Application ID') ?></th><td><?php echo $applications['temporary_id']; ?></td></tr>
                                ...
                                <tr><th><?= __('Religion') ?></th><td><?php echo $applications['religion'] ? $religions[$applications['religion']] : ""; ?></td></tr>
