...
$religions = array_flip(Configure::read('religions'));
            ...
            <div class="portlet-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-0">
                        ...
                        <a href="<?=$this->Url->build(('/CitizenCorner/pdf_view/'.$application['id']), true)?>" target="_blank" class="btn green-haze btn-circle btn-sm todo-projects-config">
                            <i class="fa fa-file-pdf-o"></i> PDF
                        </a>
                        <a href="<?=$this->Url->build(('/CitizenCorner/pdfViewApplication/'.$application['id']), true)?>" target="_blank" class="btn green-haze btn-circle btn-sm todo-projects-config">
